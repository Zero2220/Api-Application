...
public class FlowerService : IFlowerService
{
    ...
    private const string baseUrl = "https://localhost:7061/api/flowers/";

    public FlowerService(IHttpContextAccessor httpContextAccessor)
    {
    ...
    public async Task<CreateResponse> Create<TRequest>(TRequest request)
    {
        SetAuthorizationHeader();
